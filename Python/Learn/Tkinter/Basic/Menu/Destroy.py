...
def Exist_Program():
    confirm = tkinter.messagebox.askquestion("Comfirm","Are you sure to Exist?")
    if confirm == "yes":
        pass
    else:
        root.destroy() #Use Destroy command to exist window
#Create Menu
myMenu = Menu()
...
MenuItem.add_command(label="Exist" ,command=Exist_Program)
